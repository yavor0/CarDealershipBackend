    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mileage', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1)])),
                ('transmission', models.CharField(choices=[('Manual', 'Manual'), ('Automatic', 'Automatic')], max_length=50)),
                ('type', models.CharField(choices=[('SUV', 'SUV'), ('Hatchback', 'Hatchback'), ('Crossover', 'Crossover'), ('Convertible', 'Convertible'), ('Sedan', 'Sedan'), ('Sports Car', 'Sports Car'), ('Coupe', 'Coupe'), ('Minivan', 'Minivan'), ('Station Wagon', 'Station Wagon'), ('Pickup Truck', 'Pickup Truck')], max_length=50)),
